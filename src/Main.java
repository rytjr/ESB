...
//		ctx = new ClassPathXmlApplicationContext("step07/bean.xml");
//		ctx = new ClassPathXmlApplicationContext("step08_snd/bean.xml");
//		ctx = new ClassPathXmlApplicationContext("step08_rcv/bean.xml");
}
}
