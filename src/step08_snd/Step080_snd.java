...
public class Step080_snd {

    private static final String[] specialChar = {"<", ">", "'", "\"", "&"};
    private static Log log = LogFactory.getLog(Step080_snd.class);
    ...
    private String getSendMsg(String dbmsg) {
        String msg = "<?xml version=\"1.0\"?><root><header><time>" + System.currentTimeMillis()
                + "<time></header><body>" + dbmsg + "</body></root>";
        return msg;
    }
    ...
    public DataSource getDs() {return this.ds;}
    ...
    public JmsTemplate getJmsTemplate() { return this.jmsTemplate;}
